...
public class GCMSubTaskImpl extends ASTWrapperPsiElement implements GCMSubTask {

  public GCMSubTaskImpl(ASTNode node) {
    super(node);
  }
  ...
  public GCMTaskValueDeclaration getTaskValueDeclaration() {
    return findNotNullChildByClass(GCMTaskValueDeclaration.class);
  }
