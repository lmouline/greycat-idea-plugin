...
public class GCMToOneDeclarationImpl extends ASTWrapperPsiElement implements GCMToOneDeclaration {

  public GCMToOneDeclarationImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GCMVisitor visitor) {
    visitor.visitToOneDeclaration(this);
  }
